...
""" Esta forma de declararlo te va a dar siempre error, porque python
funcion de arriba abajo.
Por mas que no uses la funcion desde el principio,python tiene que
"verla" antes de ser llamada propiamente
"""

parametros_variables = "hola"

funcion2(parametros_variables)


def funcion2(parametros_variables):
    pass
